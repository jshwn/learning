[다시 풀 문제]
4, 6, 7, 12, 18, 19, 22, 23, 29, 37, 41, 45, 49, 56, 57, 63, 67, 90, 98 100, 103, 114, 115, 122, 126, 130, 133, 137, 140

[해설 필요]
37, 41, 43, 51, 52(1번 문항), 53,, 70, 72, 77, 79, 89, 90, 91, 93, 98, 100, 101, 102, 105
...
*   서브쿼리를 사용할 때 주의 사항
    *   서브쿼리는 괄호를 감싸서 사용한다.
    *   서브쿼리는 메인쿼리의 모든 칼럼에 접근할 수 있지만, 메인쿼리는 서브쿼리의 칼럼에 접근할 수 있다. 따라서 메인쿼리에서 서브쿼리에 접근하려면 스칼라 서브쿼리를 사용하거나 아예 조인 방식을 사용해야 한다.
